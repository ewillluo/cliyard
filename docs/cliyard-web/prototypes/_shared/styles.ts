/**
 * cliyard Web 原型设计 token
 * =============================================
 * 供 prototypes 下各原型（command-panel 等）统一引用。
 * 风格对齐 aiagents/docs/agent-platform/prototypes/_shared/styles.ts：
 * 所有颜色/间距/圆角/字号/阴影都收敛在此，组件内不散落 magic number。
 */
